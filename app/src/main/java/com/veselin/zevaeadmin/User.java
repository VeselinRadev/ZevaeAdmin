...
public class User {
    ...
    public User(String id, String username, String imageURL, String description, String birthday, String country, String gender, int friendsCount, int interactionsCount, String email, Double latitude, Double longitude, String lastLocationTime, String lastOnline, String isBanned) {
        this.id = id;
